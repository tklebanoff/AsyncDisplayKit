...
+ (void)drawRect:(CGRect)bounds withParameters:(NSDictionary<NSObject>*)parameters isCancelled:(asdisplaynode_iscancelled_block_t)isCancelledBlock isRasterizing:(BOOL)isRasterizing
{
